...
INPUT_FILE = "data/mlb/2025/raw/2025-pitching.txt"
...
def main():
    ...
    with open("data/mlb/2025/processed/pitching_2025_raw.json", "w", encoding="utf-8") as f:   #  ----- commented out to avoid overwriting
